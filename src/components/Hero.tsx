...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted to-secondary overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-20 w-32 h-32 rounded-full bg-gradient-to-r from-primary/20 to-yellow-500/20 blur-3xl animate-float"></div>
        <div className="absolute bottom-20 right-20 w-40 h-40 rounded-full bg-gradient-to-r from-yellow-500/20 to-primary/20 blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      </div>

      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          {/* Logo/Brand Name */}
          <h1 className="font-display text-6xl md:text-8xl font-bold text-foreground mb-6 tracking-wide">
          ...
          {/* Tagline */}
          <p className="font-display text-xl md:text-3xl text-muted-foreground mb-12 italic max-w-3xl mx-auto leading-relaxed">
